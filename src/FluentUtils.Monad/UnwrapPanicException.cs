...
/// <summary>
///     A <see cref="InvalidOperationException" /> which occurs when unwrapping an errored
///     <see cref="FluentUtils.Monad.OkResultType{T}" />
/// </summary>
/// <param name="error">
///     The <see cref="Error" /> stored in the errored <see cref="FluentUtils.Monad.OkResultType{T}" />
/// </param>
[PublicAPI]
