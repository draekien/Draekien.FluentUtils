...
public static class PipeAsyncExtensions
{
    ...
    /// <summary>
    ///     Pipes the value of an asynchronous <see cref="ResultType{T}" />
    ///     to another type if the <see cref="ResultType{T}" /> is an
    ///     <see cref="OkResultType{T}" />, otherwise
    ///     pipes the <see cref="ErrorResultType{T}" /> to the target type
    /// </summary>
    /// <param name="result">The asynchronous <see cref="ResultType{T}" /></param>
