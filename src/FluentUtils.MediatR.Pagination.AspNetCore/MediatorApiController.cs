...
namespace FluentUtils.MediatR.Pagination
{
    ...
    public abstract class MediatorApiController : ControllerBase
    {
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">The mediator services has not been registered.</exception>
        protected IMediator Mediator
        {
            get
            {
                ...
                _mediator = mediator
                         ?? throw new InvalidOperationException("MediatR has not been registered in the current services collection.");
        ...
        protected Links CreatePaginationLinks<TResult>(
            ...
            PaginatedResponse<TResult> response) => new()
        {
